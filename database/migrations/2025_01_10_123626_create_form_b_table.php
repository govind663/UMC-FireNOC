...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('form_b', function (Blueprint $table) {
                ...
                $table->string('construction_plan_doc')->nullable();
                $table->integer('status')->default('0')->comment('0:Pending, 1:Unpaid, 2:Paid, 3:Approved, 4:Rejected, 5:Underprocess, 6:Reviewed, 7:ChekerMaker, 8:NewApplication');
                ...
                $table->integer('inspector_status')->default('0')->comment('1:Approved, 2:Rejected');
                $table->integer('inspector_by')->nullable();
                $table->date('inspector_dt')->nullable();
                $table->string('f_inspector_doc')->nullable();
                $table->string('f_inspector_remarks')->nullable();
                $table->date('f_inspector_dt')->nullable();
                $table->integer('officer_status')->default('0')->comment('1:Approved, 2:Rejected');
                $table->integer('officer_by')->nullable();
                $table->date('officer_dt')->nullable();
