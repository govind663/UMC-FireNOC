...
<body data-topbar="colored" data-layout="horizontal">
                        ...
                        <div class="col-lg-12">
                            <div class="card" style="border: 1px solid #000000;">
                                <div class="card-body p-0">
                                    ...
                                    <form class="auth-input p-4" method="POST" action="{{ url('/new_hospital_noc/store') }}" enctype="multipart/form-data" autocomplete="off" >
                                        @csrf
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="hospital_name" id="hospital_name" class="form-control @error('hospital_name') is-invalid @enderror" value="{{ old('hospital_name') }}" placeholder="Enter Name of Hospital." oninput="this.value = this.value.replace(/[^A-Za-z]/g, '');">
                                                @error('hospital_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="area_pincode" id="area_pincode" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="06" class="form-control @error('area_pincode') is-invalid @enderror" value="{{ old('area_pincode') }}" placeholder="Enter Pincode.">
                                                @error('area_pincode')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <select class="form-control select2 @error('types_of_hospital') is-invalid @enderror" name="types_of_hospital" id="types_of_hospital">
                                                    ...
                                                    <optgroup label=" ">
                                                        <option value="1" {{ old('types_of_hospital') == "1"? 'selected' : '' }}>Temporary</option>
                                                        <option value="2" {{ old('types_of_hospital') == "2"? 'selected' : '' }}>Fixed</option>
                                                    </optgroup>
                                                </select>
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="total_staff" id="total_staff" class="form-control @error('total_staff') is-invalid @enderror" value="{{ old('total_staff') }}" placeholder="Enter Numbers of Staff.">
                                                @error('total_staff')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="total_sleeping_staff" id="total_sleeping_staff" class="form-control @error('total_sleeping_staff') is-invalid @enderror" value="{{ old('total_sleeping_staff') }}" placeholder="Enter Number of Staff sleep at night at working place">
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <textarea type="text" name="hospital_address" id="hospital_address" class="form-control @error('hospital_address') is-invalid @enderror" value="{{ old('hospital_address') }}" placeholder="Enter Address Of Hospital Place." style="height: 80px; width:100%;" >{{ old('hospital_address') }}</textarea>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="form-group row  mb-3">
                                                    <label class="col-sm-2"><strong>Upload Document Of Property : </strong></label>
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="property_doc" id="property_doc" class="form-control  @error('property_doc') is-invalid @enderror " value="{{ old('property_doc') }}" placeholder="Upload Document Of Property.">
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="electric_doc" id="electric_doc" class="form-control  @error('electric_doc') is-invalid @enderror " value="{{ old('electric_doc') }}" placeholder="Upload Letter from License Holder regarding proper electric connection.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="shop_license_doc" id="shop_license_doc" class="form-control @error('shop_license_doc') is-invalid @enderror" value="{{ old('shop_license_doc') }}" placeholder="Enter Shop License.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="paid_tax_bill_doc" id="paid_tax_bill_doc" class="form-control  @error('paid_tax_bill_doc') is-invalid @enderror " value="{{ old('paid_tax_bill_doc') }}" placeholder="Upload Up-to-date receipt of Tax bill paid.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                        @error('paid_tax_bill_doc')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                        @enderror
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="commissioning_certificate" id="commissioning_certificate" class="form-control @error('commissioning_certificate') is-invalid @enderror" value="{{ old('commissioning_certificate') }}" placeholder="Enter Commissioning Certificate of Fire extinguishers / preventive equipments of I.S.I. Mark.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    <label class="col-sm-2"><strong>Upload Copy of Affidavit : </strong></label>
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="affidavit_doc" id="affidavit_doc" class="form-control  @error('affidavit_doc') is-invalid @enderror " value="{{ old('affidavit_doc') }}" placeholder="Upload Copy of Affidavit.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                    ...
                                                    <label class="col-sm-2"><strong>Upload Corporation Registration certificate (FOR OLD HOSPITAL) : </strong></label>
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="corporation_certificate" id="corporation_certificate" class="form-control @error('corporation_certificate') is-invalid @enderror" value="{{ old('corporation_certificate') }}" placeholder="Enter Shop License.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                        @error('corporation_certificate')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                        @enderror
                                                ...
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="col-md-12 col-xs-12">
                                                        <p class="text-justify ">
                                                            <b> I / We..... <br><br>
                                                                <input type="text"  class="form-control @error('declare_by') is-invalid @enderror" id="declare_by" name="declare_by" value="{{ old('declare_by') }}" placeholder="Enter Applicant Name" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '');">
                                                                <br>
                                                                @error('declare_by')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
    ...
    document.getElementById('from_date').addEventListener('change', function() {
        ...
        if (fromDate) {
            ...
            // Add one year to the "From Date"
            fromDateObj.setFullYear(fromDateObj.getFullYear() + 1);
            
            // Format the new date to match the input format (YYYY-MM-DD)
            var yearLaterDate = fromDateObj.toISOString().split('T')[0];
            
            // Set the "To Date" field to the new date
            document.getElementById('to_date').value = yearLaterDate;
        }
    });
</script>
