                                ...
                                <div class="card-body p-0">
                                    ...
                                    <form class="auth-input p-4" method="POST" action='{{ url("/new_hospital_noc/edit/update/{$data->NH_NOC_ID}/{$data->d_ID}/{$data->status}") }}' enctype="multipart/form-data" autocomplete="off" >
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="tel_no" id="tel_no" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="10" class="form-control" value="{{ $data->tel_no }}" placeholder="Enter Telephone No. (if any).">
                                                @error('tel_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="date" name="from_date" id="from_date"  class="form-control " value="{{  Carbon\Carbon::parse($data->from_date)->format('Y-m-d')  }}" placeholder="Enter From Date.">
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="date" name="to_date" id="to_date"  class="form-control " value="{{  Carbon\Carbon::parse($data->to_date)->format('Y-m-d')  }}" placeholder="Enter To Date.">
