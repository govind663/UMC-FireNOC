                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                <img src="{{ public_path('/PMC_FireNOC/Hospital_NOC/New_HospitalNOC/property_doc') }}/{{ $data->property_doc }}" alt="image" width="100%" height="21%">
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Hospital_NOC/New_HospitalNOC/electric_doc') }}/{{ $data->electric_doc }}" alt="image" width="100%" height="21%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Hospital_NOC/New_HospitalNOC/shop_license_doc') }}/{{ $data->shop_license_doc }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Hospital_NOC/New_HospitalNOC/paid_tax_bill_doc') }}/{{ $data->paid_tax_bill_doc }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Hospital_NOC/New_HospitalNOC/commissioning_certificate') }}/{{ $data->commissioning_certificate }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Hospital_NOC/New_HospitalNOC/affidavit_doc') }}/{{ $data->affidavit_doc }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Hospital_NOC/New_HospitalNOC/corporation_certificate') }}/{{ $data->corporation_certificate }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Hospital_NOC/New_HospitalNOC/construction_plan_doc') }}/{{ $data->construction_plan_doc }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
