                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body" style="border: 1px solid rgb(3, 155, 155);">
                                        ...
                                        @elseif($status == 7)
                                        <h4 class="card-header text-primary">All Invoice Generated New Hospital NOC List</h4>
                                        @endif
                                                ...
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <a href='{{ url("/download_new_hospital_noc_pdf/{$value->NH_NOC_ID}/{$value->status}") }}' class="btn btn-dark btn-sm ">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <form action='{{ url("/new_hospital_noc/delete/{$value->NH_NOC_ID}/{$value->d_ID}/{$value->status}") }}' method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                            ...
                                                            <button type="button" class="btn btn-warning text-dark btn-sm waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg_{{ $value->NH_NOC_ID }}">Upload Payment Recepit</button>
                                                            @endif
                                                        </td>
                                                    </tr>

                                                    {{-- Payment Receipt --}}
                                                    <div class="modal fade bs-example-modal-lg_{{ $value->NH_NOC_ID }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <form class="auth-input p-4"  method="POST" action='{{ url("/upload_payment_receipt/{$value->NH_NOC_ID}/{$value->status}/{$value->noc_mode}") }}' enctype="multipart/form-data" autocomplete="off" >
                                                                            @csrf
