                        ...
                        <div class="col-lg-12">
                            <div class="card" style="border: 1px solid #000000;">
                                <div class="card-body p-0">
                                    <h4 class="card-header text-light bg-primary ">Edit Renew Hospital Business NOC</h4>

                                    <form class="auth-input p-4" method="POST" action='{{ url("/renew_hospital_noc/edit/update/{$data->RH_NOC_ID}/{$data->d_ID}/{$data->status}") }}' enctype="multipart/form-data" autocomplete="off" >
                                        @csrf
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="area_pincode" id="area_pincode" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="06" class="form-control @error('area_pincode') is-invalid @enderror" value="{{ $data->area_pincode }}" placeholder="Enter Pincode.">
                                                @error('area_pincode')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="row ">
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="property_doc" id="property_doc" class="form-control  @error('property_doc') is-invalid @enderror " value="{{ $data->property_doc }}" placeholder="Upload Document Of Property.">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="location_doc" id="location_doc" class="form-control @error('location_doc') is-invalid @enderror" value="{{ $data->location_doc }}" placeholder="Enter Copy of Previous NOC.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="electric_doc" id="electric_doc" class="form-control  @error('electric_doc') is-invalid @enderror " value="{{ $data->electric_doc }}" placeholder="Upload Letter from License Holder regarding proper electric connection.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="shop_license_doc" id="shop_license_doc" class="form-control @error('shop_license_doc') is-invalid @enderror" value="{{ $data->shop_license_doc }}" placeholder="Enter Shop License.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="paid_tax_bill_doc" id="paid_tax_bill_doc" class="form-control  @error('paid_tax_bill_doc') is-invalid @enderror " value="{{ $data->paid_tax_bill_doc }}" placeholder="Upload Up-to-date receipt of Tax bill paid.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="commissioning_certificate" id="commissioning_certificate" class="form-control @error('commissioning_certificate') is-invalid @enderror" value="{{ $data->commissioning_certificate }}" placeholder="Enter Commissioning Certificate of Fire extinguishers / preventive equipments of I.S.I. Mark.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="affidavit_doc" id="affidavit_doc" class="form-control  @error('affidavit_doc') is-invalid @enderror " value="{{ $data->affidavit_doc }}" placeholder="Upload Copy of Affidavit.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="corporation_certificate" id="corporation_certificate" class="form-control @error('corporation_certificate') is-invalid @enderror" value="{{ $data->corporation_certificate }}" placeholder="Enter Shop License.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="construction_plan_doc" id="construction_plan_doc" class="form-control  @error('construction_plan_doc') is-invalid @enderror " value="{{ $data->construction_plan_doc }}" placeholder="Upload Construction Blueprints for Renew Hospital.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
