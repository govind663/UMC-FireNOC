                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                <iframe src="{{ public_path('/UMC_FireNOC/Hospital_NOC/Renew_HospitalNOC/location_doc') }}/{{ $data->location_doc }} " height='100%' width='25%'></iframe>
                                @else
                                {{"No Map Found"}}
                                @endif
                            </div>
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                <iframe src="{{ public_path('/UMC_FireNOC/Hospital_NOC/Renew_HospitalNOC/property_doc') }}/{{ $data->property_doc }} " height='100%' width='25%'></iframe>
                                @else
                                {{"No Map Found"}}
                                @endif
                            </div>
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                <iframe src="{{ public_path('/UMC_FireNOC/Hospital_NOC/Renew_HospitalNOC/electric_doc') }}/{{ $data->electric_doc }} " height='100%' width='25%'></iframe>
                                @else
                                {{"No Map Found"}}
                                @endif
                            </div>
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                <iframe src="{{ public_path('/UMC_FireNOC/Hospital_NOC/Renew_HospitalNOC/shop_license_doc') }}/{{ $data->shop_license_doc }} " height='100%' width='25%'></iframe>
                                @else
                                {{"No Map Found"}}
                                @endif
                            </div>
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                <iframe src="{{ public_path('/UMC_FireNOC/Hospital_NOC/Renew_HospitalNOC/paid_tax_bill_doc') }}/{{ $data->paid_tax_bill_doc }} " height='100%' width='25%'></iframe>
                                @else
                                {{"No Map Found"}}
                                @endif
                            </div>
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                <iframe src="{{ public_path('/UMC_FireNOC/Hospital_NOC/Renew_HospitalNOC/commissioning_certificate') }}/{{ $data->commissioning_certificate }} " height='100%' width='25%'></iframe>
                                @else
                                {{"No Map Found"}}
                                @endif
                            </div>
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                <iframe src="{{ public_path('/UMC_FireNOC/Hospital_NOC/Renew_HospitalNOC/affidavit_doc') }}/{{ $data->affidavit_doc }} " height='100%' width='25%'></iframe>
                                @else
                                {{"No Map Found"}}
                                @endif
                            </div>
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                <iframe src="{{ public_path('/UMC_FireNOC/Hospital_NOC/Renew_HospitalNOC/corporation_certificate') }}/{{ $data->corporation_certificate }} " height='100%' width='25%'></iframe>
                                @else
                                {{"No Map Found"}}
                                @endif
                            </div>
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                <iframe src="{{ public_path('/UMC_FireNOC/Hospital_NOC/Renew_HospitalNOC/construction_plan_doc') }}/{{ $data->construction_plan_doc }} " height='100%' width='25%'></iframe>
                                @else
                                {{"No Map Found"}}
                                @endif
                            </div>
