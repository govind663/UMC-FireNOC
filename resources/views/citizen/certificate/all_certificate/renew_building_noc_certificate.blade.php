                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="letter">
                                    ...
                                    <div>
                                        <div style="float: left;">टोकन क्र:- {{ $data->mst_token }}</div>
                                        ...
                                        <b>
                                            <p style="text-align: center;"> <u>"इमारत/सीएनजी/पेट्रोल/डिझेल पंप नुतनीकरण
                                                    ना हरकत दाखला”</u></p>
                                        </b><br>
                                        <p>आपला दिनांक :-
                                            {{ \Carbon\Carbon::parse($data->inserted_dt)->format('j/m/Y') }} चे
                                            अर्जानुसार आपल्या {{ $data->society_name }} इमारत/सीएनजी/पेट्रोल/डिझेल पंप
                                    ...
                                    <div class="signature">
                                        <div>
                                            <img class="avatar-image"
                                                src="{{ url('/') }}/PMC_FireNOC/signature_doc/{{ $cf_signature->upload_signature_doc ?? null }}"
