                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        ...
                                        <form class="auth-input p-4"  method="POST" action='{{ url("/new_other_noc/edit/update/{$data->NC_NOC_ID}/{$data->d_ID}/{$data->status}") }}' enctype="multipart/form-data" autocomplete="off" >
                                            @csrf
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <input type="text" name="society_name" id="society_name" class="form-control @error('society_name') is-invalid @enderror" value="{{ $data->society_name }}" placeholder="Enter Name of Society." oninput="this.value = this.value.replace(/[^A-Za-z]/g, '');">
                                                    @error('society_name')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <select class="form-control select2 @error('types_of_business') is-invalid @enderror" name="types_of_other" id="types_of_other">
                                            ...
                                            <div class="row "  >
                                                ...
                                                <div class="form-group row  mb-3">
                                                    <label class="col-sm-2"><strong>Upload Location of Place (Google Map Link) : </strong></label>
                                            ...
                                            <div class="form-group row mt-4" >
                                                ...
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/new_other_noc_list', $data->status) }}" class="btn btn-danger">Cancel</a>&nbsp;&nbsp;
