                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        <h4 class="card-header text-light bg-primary ">Add New Other NOC</h4>

                                        <form class="auth-input p-4"  method="POST" action="{{ url('/new_other_noc/store') }}" enctype="multipart/form-data" autocomplete="off" >
                                            @csrf

                                            <div class="form-group row mb-3">
                                                <label for="nocs_a_date" class="col-sm-2"><strong>Appication Date : </strong></label>
                                            ...
                                            <div class="form-group row mb-3 d-none">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <select class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden">
                                                        ...
                                                        <optgroup label=" ">
                                                            <option value="8" {{ old('noc_mode') == "8" ? 'selected' : '' }} selected>New Other NOC</option>
                                                            <option value="9" {{ old('noc_mode') == "9" ? 'selected' : '' }}>Renewal Other NOC</option>
                                                        </optgroup>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row  mb-3">
                                                <label class="col-sm-2"><strong>Name of Other : <span class="text-danger">*</span></strong></label>
                                                <div class="col-sm-2 col-md-2">
                                                    <input type="text" name="society_name" id="society_name" class="form-control @error('society_name') is-invalid @enderror" value="{{ old('society_name') }}" placeholder="Enter Name of Other." oninput="this.value = this.value.replace(/[^A-Za-z]/g, '');">
                                                    @error('society_name')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <input type="text" name="tel_no" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" id="tel_no" class="form-control" value="{{ old('tel_no') }}" placeholder="Enter Telephone No. (if any).">
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <input type="number" name="area" id="area"  class="form-control @error('area') is-invalid @enderror" value="{{ old('area') }}" placeholder="Enter Area of Place (Sq. Mt.)">
                                                    @error('area')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
