                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <form class="auth-input p-4" >
                                            ...
                                            <div class="form-group row mb-3 d-none">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <select disabled class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden">
                                                        ...
                                                        <optgroup label=" ">
                                                            <option value="1" {{ $data->noc_mode == "1" ? 'selected' : '' }} selected>New Other NOC</option>
                                                            <option value="2" {{ $data->noc_mode == "2" ? 'selected' : '' }}>Renewal Other NOC</option>
                                                        </optgroup>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <select disabled class="form-control select2 @error('types_of_other') is-invalid @enderror" name="types_of_other" id="types_of_other">
