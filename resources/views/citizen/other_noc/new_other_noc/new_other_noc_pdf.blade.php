...
<head>
    ...
    <title>PMC-Fire NOC | New Business NOC</title>
            ...
            <form class="auth-input" style="padding-top: 150px;">
                ...
                @php
                    ...
                    if ($data->types_of_business == 1) {
                        $types_of_business = 'Temporary';
                    } elseif ($data->types_of_business == 2) {
                        $types_of_business = 'Fixed';
                    }
                @endphp
                @php
                    $fire_equips = '';
                ...
                <table class="table table-bordered table-responsive" style="width: 100%;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="4">{{ ($types_of_business) }}</td>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                <img src="{{ public_path('/PMC_FireNOC/Business_NOC/New_BusinessNOC/electric_license_doc') }}/{{ $data->electric_license_doc }}" alt="image" width="100%" height="35%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                @if(!empty($data->electric_license_doc))
                                    <a href="{{url('/')}}/PMC_FireNOC/Business_NOC/New_BusinessNOC/electric_license_doc/{{ $data->electric_license_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                        <b>View Document</b>
                                    </a>
                                @endif
                                @else
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Business_NOC/New_BusinessNOC/gas_license_doc') }}/{{ $data->gas_license_doc }}" alt="image" width="100%" height="35%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                @if(!empty($data->gas_license_doc))
                                    <a href="{{url('/')}}/PMC_FireNOC/Business_NOC/New_BusinessNOC/gas_license_doc/{{ $data->gas_license_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                        <b>View Document</b>
                                    </a>
                                @endif
                                @else
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Business_NOC/New_BusinessNOC/shop_license_doc') }}/{{ $data->shop_license_doc }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                @if(!empty($data->shop_license_doc))
                                    <a href="{{url('/')}}/PMC_FireNOC/Business_NOC/New_BusinessNOC/shop_license_doc/{{ $data->shop_license_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                        <b>View Document</b>
                                    </a>
                                @endif
                                @else
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Business_NOC/New_BusinessNOC/food_license') }}/{{ $data->food_license }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                @if(!empty($data->food_license))
                                    <a href="{{url('/')}}/PMC_FireNOC/Business_NOC/New_BusinessNOC/food_license/{{ $data->food_license }}" target="_blank" class="btn btn-primary btn-sm">
                                        <b>View Document</b>
                                    </a>
                                @endif
                                @else
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Business_NOC/New_BusinessNOC/tax_bill_paid_doc') }}/{{ $data->tax_bill_paid_doc }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                @if(!empty($data->tax_bill_paid_doc))
                                    <a href="{{url('/')}}/PMC_FireNOC/Business_NOC/New_BusinessNOC/tax_bill_paid_doc/{{ $data->tax_bill_paid_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                        <b>View Document</b>
                                    </a>
                                @endif
                                @else
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Business_NOC/New_BusinessNOC/trade_license') }}/{{ $data->trade_license }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                @if(!empty($data->trade_license))
                                    <a href="{{url('/')}}/PMC_FireNOC/Business_NOC/New_BusinessNOC/trade_license/{{ $data->trade_license }}" target="_blank" class="btn btn-primary btn-sm">
                                        <b>View Document</b>
                                    </a>
                                @endif
                                @else
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Business_NOC/New_BusinessNOC/gas_certificate_doc') }}/{{ $data->gas_certificate_doc }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                @if(!empty($data->gas_certificate_doc))
                                    <a href="{{url('/')}}/PMC_FireNOC/Business_NOC/New_BusinessNOC/gas_certificate_doc/{{ $data->gas_certificate_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                        <b>View Document</b>
                                    </a>
                                @endif
                                @else
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Business_NOC/New_BusinessNOC/commissioning_certificate') }}/{{ $data->commissioning_certificate }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                @if(!empty($data->commissioning_certificate))
                                    <a href="{{url('/')}}/PMC_FireNOC/Business_NOC/New_BusinessNOC/commissioning_certificate/{{ $data->commissioning_certificate }}" target="_blank" class="btn btn-primary btn-sm">
                                        <b>View Document</b>
                                    </a>
                                @endif
                                @else
                    ...
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Business_NOC/New_BusinessNOC/affidavit_doc') }}/{{ $data->affidavit_doc }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                @if(!empty($data->affidavit_doc))
                                    <a href="{{url('/')}}/PMC_FireNOC/Business_NOC/New_BusinessNOC/affidavit_doc/{{ $data->affidavit_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                        <b>View Document</b>
                                    </a>
                                @endif
                                @else
                ...
                <table class="table table-bordered table-responsive" style="width: 100%;">
                    <thead>
                        <th class="col-12">Construction Maps of Proposed Construction : </th>
                    </thead>
                    <tbody>
                        <td class="col-8">
                            <div class="form-group">
                                ...
                                @if($filter_ext == 'jpg' || $filter_ext=='jpeg' || $filter_ext == 'png' || $filter_ext == 'gif' ||
                                    $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                <img src="{{ public_path('/PMC_FireNOC/Business_NOC/New_BusinessNOC/construction_plan_doc') }}/{{ $data->construction_plan_doc }}" alt="image" width="100%" height="25%">
                                @elseif ($filter_ext == 'pdf' || $filter_ext == 'PDF')
                                @if(!empty($data->construction_plan_doc))
                                    <a href="{{url('/')}}/PMC_FireNOC/Business_NOC/New_BusinessNOC/construction_plan_doc/{{ $data->construction_plan_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                        <b>View Document</b>
                                    </a>
                                @endif
                                @else
