                        ...
                        <div class="col-lg-12">
                            <div class="card" style="border: 1px solid #000000;">
                                <div class="card-body p-0">
                                    <h4 class="card-header text-light bg-primary ">Add Renew Other NOC</h4>

                                    <form class="auth-input p-4" method="POST" action="{{ url('/renew_other_noc/store') }}" enctype="multipart/form-data" autocomplete="off" >
                                        @csrf
                                        ...
                                        <div class="form-group row mb-3 d-none">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <select class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden">
                                                    ...
                                                    <optgroup label=" ">
                                                        <option value="8" {{ old('noc_mode') == "8" ? 'selected' : '' }}>New Other NOC</option>
                                                        <option value="9" {{ old('noc_mode') == "9" ? 'selected' : '' }} selected>Renewal Other NOC</option>
                                                    </optgroup>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row  mb-3">
                                            <label class="col-sm-2"><strong>Name of  Other Business : <span class="text-danger">*</span></strong></label>
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="society_name" id="society_name" class="form-control @error('society_name') is-invalid @enderror" value="{{ old('society_name') }}" placeholder="Enter Name of Business." oninput="this.value = this.value.replace(/[^A-Za-z]/g, '');">
                                                @error('society_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="tel_no" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="10" id="tel_no" class="form-control" value="{{ old('tel_no') }}" placeholder="Enter Telephone No. (if any).">
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <label class="col-sm-2"><strong>Type of  Other Business : </strong></label>
                                            <div class="col-sm-2 col-md-2">
                                                <select class="form-control select2 @error('types_of_other') is-invalid @enderror" name="types_of_other" id="types_of_other">
                                                    <option value="">Select Type of Other Business</option>
                                                    <optgroup label=" ">
                                                        <option value="1" {{ old('types_of_other') == "1"? 'selected' : '' }}>Temporary</option>
                                                        <option value="2" {{ old('types_of_other') == "2"? 'selected' : '' }}>Fixed</option>
                                                    </optgroup>
                                                </select>
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <label class="col-sm-2"><strong>Nature / Particulars of Other Business : </strong></label>
                                            <div class="col-sm-2 col-md-2">
                                                <select class="form-control select2 @error('other_nature_id') is-invalid @enderror" name="other_nature_id" id="other_nature_id">
                                                    <option value="">Select Nature / Particulars of  Other Business</option>
                                                    <optgroup label="">
                                                        @foreach ($busines_mst as $value )
                                                        <option value="{{ $value->id }}" {{ old('other_nature_id') == "1" ? 'selected' : '' }}>{{ $value->other_nature }}</option>
                                                        @endforeach
                                                </select>
                                                @error('other_nature_id')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                                @enderror
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <label class="col-sm-2"><strong>Address Of Other Business Place : </strong></label>
                                            <div class="col-sm-5 col-md-5">
                                                <textarea type="text" name="other_address" id="other_address" class="form-control @error('other_address') is-invalid @enderror" value="{{ old('other_address') }}" placeholder="Enter Address Of Business Place">{{ old('other_address') }}</textarea>
                                                @error('other_address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
