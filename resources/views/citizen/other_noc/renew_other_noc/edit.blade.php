                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        <h4 class="card-header text-light bg-primary ">Edit Renew Other NOC</h4>

                                        <form class="auth-input p-4"  method="POST" action='{{ url("/renew_other_noc/edit/update/{$data->RB_NOC_ID}/{$data->d_ID}/{$data->status}") }}' enctype="multipart/form-data" autocomplete="off" >
                                            @csrf
                                            ...
                                            <div class="form-group row mb-3 d-none">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <select class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden">
                                                        ...
                                                        <optgroup label=" ">
                                                            {{-- <option value="8" {{ $data->noc_mode == "8" ? 'selected' : '' }}>New Bussiness NOC</option> --}}
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <label class="col-sm-2"><strong>Father / Husband's Name : <span class="text-danger">*</span></strong></label>
                                                <div class="col-sm-2 col-md-2">
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <input type="text" name="society_name" id="society_name" class="form-control @error('society_name') is-invalid @enderror" value="{{ $data->society_name }}" placeholder="Enter Name of Business.">
                                                    @error('society_name')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="row "  >
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <label class="col-sm-2"><strong>Upload Commissioning Certificate of Gas Fitting : </strong></label>
                                                    <div class="col-sm-4 col-md-4">
                                            ...
                                            <div class="form-group row mt-4" >
                                                ...
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('renew_other_noc_list', $data->status) }}" class="btn btn-danger">Cancel</a>&nbsp;&nbsp;
