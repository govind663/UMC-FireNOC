                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body" style="border: 1px solid rgb(3, 155, 155);">
                                        ...
                                        @if($status == 0)
                                        <h4 class="card-header text-primary">All Pending New Form B List</h4>
                                        @elseif($status == 1)
                                        <h4 class="card-header text-primary">All Unpaid New Form B List</h4>
                                        @elseif($status == 2)
                                        <h4 class="card-header text-primary">All Paid New Form B List</h4>
                                        @elseif($status == 3)
                                        ...
                                        @elseif($status == 5)
                                        <h4 class="card-header text-primary">All Underprocess New Form B List</h4>
                                        @elseif($status == 6)
                                        <h4 class="card-header text-primary">All Reviewed New Form B List</h4>
                                        @elseif($status == 7)
                                        <h4 class="card-header text-primary">All Invoice Generated New Form B List</h4>
                                        @endif
                                                ...
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            ...
                                                            <form action='{{ url("/new_form_b/delete/{$value->FB_NOC_ID}/{$value->d_ID}/{$value->status}") }}' method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                            ...
                                                            &nbsp;&nbsp;
                                                            {{-- @if ($value->status == 1)
                                                            <a href='{{ url("/make_payment/create/{$value->FB_NOC_ID}/{$value->status}/{$value->noc_mode}") }}' class="btn btn-success btn-sm ">
                                                            ...
                                                            <a href='{{ url("/invoice/{$value->FB_NOC_ID}/{$value->status}/{$value->noc_mode}") }}' class="btn btn-dark btn-sm ">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            @if ($value->status == 3 )
                                                            <a href='{{ url("/certificate/{$value->FB_NOC_ID}/{$value->status}/{$value->noc_mode}") }}' class="btn btn-warning btn-sm text-dark">
                                                        ...
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <form class="auth-input p-4"  method="POST" action='{{ url("/upload_payment_receipt/{$value->FB_NOC_ID}/{$value->status}/{$value->noc_mode}") }}' enctype="multipart/form-data" autocomplete="off" >
                                                                            @csrf
