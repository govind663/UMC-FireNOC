...
<html lang="en">
    ...
    <head>
        ...
        <title>PMC-Fire NOC | Renew Business NOC List</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body" style="border: 1px solid rgb(3, 155, 155);">
                                        ...
                                        @if($status == 0)
                                        <h4 class="card-header text-primary">All Pending Renew Business NOC List</h4>
                                        @elseif($status == 1)
                                        <h4 class="card-header text-primary">All Unpaid Renew Business NOC List</h4>
                                        @elseif($status == 2)
                                        <h4 class="card-header text-primary">All Paid Renew Business NOC List</h4>
                                        @elseif($status == 3)
                                                ...
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <form action='{{ url("/renew_business_noc/delete/{$value->RB_NOC_ID}/{$value->d_ID}/{$value->status}") }}' method="post">
                                                                @csrf
                                                                @method('DELETE')
