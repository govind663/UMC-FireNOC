    ...
    <div class="col-lg-12">
        <div class="card" >
            <div class="card-body p-0">
                ...
                <form class="auth-input" style="padding-top: 20px; padding-left:30px; padding-right:50px; padding-bottom:40px;">
                    ...
                    <div class="form-group row  mb-3">
                        ...
                        <div class="col-sm-2 col-md-2">
                            <select disabled class="form-control select2 @error('ward_no') is-invalid @enderror" name="ward_no" id="ward_no">
                                ...
                                <optgroup label="">
                                    <option value="1" {{ $data->ward_no == '1' ? 'selected' : '' }}>
                                        Ward 1</option>
                                    <option value="2" {{ $data->ward_no == '2' ? 'selected' : '' }}>
                                        Ward 2</option>
                                    <option value="3" {{ $data->ward_no == '3' ? 'selected' : '' }}>
                                        Ward 3</option>
                                    <option value="4" {{ $data->ward_no == '4' ? 'selected' : '' }}>
                                        Ward 4</option>
                                </optgroup>
                            </select>
                    ...
                    <div class="form-group row  mb-3">
                        ...
                        <div class="col-sm-2 col-md-2">
                            <select disabled class="form-control select2 @error('types_of_property') is-invalid @enderror" name="types_of_property" id="types_of_property">
                                ...
                                <optgroup label=" ">
                                    <option value="1" {{ $data->types_of_property == '1' ? 'selected' : ''
                                        }}>Land
                                    </option>
                                    <option value="2" {{ $data->types_of_property == '2' ? 'selected' : ''
                                        }}>Building
                                    </option>
                                </optgroup>
                            </select>
                    ...
                    <div class="form-group row  mb-3">
                        ...
                        <label class="col-sm-2"><strong>Accomodation for how many People :
                            </strong></label>
                        <div class="col-sm-2 col-md-2">
                    ...
                    <div class="form-group row  mb-3">
                        ...
                        <div class="col-sm-2 col-md-2">
                            <select disabled class="form-control select2 @error('types_of_business') is-invalid @enderror" name="types_of_business" id="types_of_business">
                                ...
                                <optgroup label=" ">
                                    <option value="1" {{ $data->types_of_business == '1' ? 'selected' : ''
                                        }}>Temporary
                                    </option>
                                    <option value="2" {{ $data->types_of_business == '2' ? 'selected' : ''
                                        }}>Fixed
                                    </option>
                                </optgroup>
                            </select>
                    ...
                    <div class="form-group row  mb-3">
                        <label class="col-sm-2"><strong>Number of Workers / Servants sleep at night at
                                working place : </strong></label>
                        <div class="col-sm-2 col-md-2">
                        ...
                        <label class="col-sm-2"><strong>Fire extinguishers/ preventive equipments are
                                installed at working place : </strong></label>
                        <div class="col-sm-2 col-md-2">
                            <select disabled class="form-control select2 @error('fire_equips') is-invalid @enderror" name="fire_equips" id="fire_equips">
                                <option value="">Select Fire extinguishers/ preventive equipments are
                                    installed at working place</option>
                                <optgroup label=" ">
                                    <option value="1" {{ $data->fire_equips == '1' ? 'selected' : '' }}>Yes
                                    </option>
                                    <option value="2" {{ $data->fire_equips == '2' ? 'selected' : '' }}>No
                                    </option>
                                </optgroup>
                            </select>
                            @error('fire_equips')
                    ...
                    <div class="row ">
                        ...
                        <div class="form-group row  mb-3">
                            <label class="col-sm-2"><strong>Location of Place (Google Map Link) :
                                </strong></label>
                            ...
                            <label class="col-sm-2"><strong>Letter from License Holder regarding proper
                                    electric connection : </strong></label>
                            <div class="col-sm-4 col-md-4">
                        ...
                        <div class="form-group row  mb-3">
                            <label class="col-sm-2"><strong>Letter from connection holder and license
                                    regarding proper cooking gas connection : </strong></label>
                            <div class="col-sm-4 col-md-4">
                        ...
                        <div class="form-group row  mb-3">
                            ...
                            <label class="col-sm-2"><strong>Up-to-date receipt of Tax bill paid :
                                </strong></label>
                            <div class="col-sm-4 col-md-4">
                        ...
                        <div class="form-group row  mb-3">
                            <label class="col-sm-2"><strong>Trade License (Kerosene/Other Petroleum Stock/
                                    Explosive goods) : </strong></label>
                            <div class="col-sm-4 col-md-4">
                            ...
                            <label class="col-sm-2"><strong>Commissioning Certificate of Gas Fitting :
                                </strong></label>
                            <div class="col-sm-4 col-md-4">
                        ...
                        <div class="form-group row  mb-3">
                            <label class="col-sm-2"><strong>Commissioning Certificate of Fire
                                    extinguishers/ preventive equipments of I.S.I. Mark : </strong></label>
                            <div class="col-sm-4 col-md-4">
                        ...
                        <div class="form-group row  mb-3">
                            <label class="col-sm-2"><strong>Construction Maps of Proposed Construction :
                                </strong></label>
                            <div class="col-sm-4 col-md-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2"><strong>Self / Nominated Person :
                                            </strong></label>
                                        <div class="col-sm-2 col-md-2">
                                            <select disabled class="form-control select2 @error('nominated_persion') is-invalid @enderror" name="nominated_persion" id="nominated_persion">
                                                <option value="">Select Self / Nominated Person
                                                </option>
                                                <optgroup label=" ">
                                                    <option value="1" {{ $data->nominated_persion == '1' ?
                                                        'selected' : '' }}>
                                                        Self</option>
                                                    <option value="2" {{ $data->nominated_persion == '2' ?
                                                        'selected' : '' }}>
                                                        Nominee</option>
                                                    <option value="3" {{ $data->nominated_persion == '3' ?
                                                        'selected' : '' }}>
                                                        C.F.C.</option>
                                                    <option value="4" {{ $data->nominated_persion == '4' ?
                                                        'selected' : '' }}>
                                                        Camp No.</option>
                                                </optgroup>
                                            </select>
                                        ...
                                        <label class="col-sm-2"><strong>Name of Nominated Person :
                                            </strong></label>
                                        <div class="col-sm-2 col-md-2">
                                        ...
                                        <div class="col-sm-2 col-md-2">
                                            <select disabled class="form-control select2 @error('deliver_by') is-invalid @enderror" name="deliver_by" id="deliver_by">
                                                ...
                                                <optgroup label=" ">
                                                    <option value="1" {{ $data->deliver_by == '1' ?
                                                        'selected' : '' }}>
                                                        By
                                                        Post U.P.C</option>
                                                    <option value="2" {{ $data->deliver_by == '2' ?
                                                        'selected' : '' }}>
                                                        By
                                                        Post Register A.D.</option>
                                                    <option value="3" {{ $data->deliver_by == '3' ?
                                                        'selected' : '' }}>
                                                        Courier</option>
                                                </optgroup>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2"><strong>Last Name / Surname :
                                            </strong></label>
                                        <div class="col-sm-2 col-md-2">
                                        ...
                                        <label class="col-sm-2"><strong>Father / Husband's Name :
                                            </strong></label>
                                        <div class="col-sm-2 col-md-2">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2"><strong>House / Building / Society Name :
                                            </strong></label>
                                        <div class="col-sm-2 col-md-2">
                                        ...
                                        <label class="col-sm-2"><strong>Flat / Block / Barrack No. :
                                            </strong></label>
                                        <div class="col-sm-2 col-md-2">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2"><strong>Road / Street / Lane :
                                            </strong></label>
                                        <div class="col-sm-2 col-md-2">
                                        ...
                                        <label class="col-sm-2"><strong>Area / Locality / Town / City :
                                            </strong></label>
                                        <div class="col-sm-2 col-md-2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2"><strong>Email Id (if any) :
                                            </strong></label>
                                        <div class="col-sm-2 col-md-2">
