...
<head>
    ...
    <meta charset="utf-8">
    <title>UMC-Fire NOC | Reset Password</title>
                                        ...
                                        <div class="card my-auto overflow-hidden">
                                            <div class="p-lg-5 p-4">
                                                <div>
                                                    ...
                                                    <form class="auth-input" method="POST" action="{{ url('/citizen/forget-password/send-email-link') }}" enctype="multipart/form">
                                                        @csrf
                                                ...
                                                <div class="mt-4 text-center">
                                                    <p class="mb-0">I have an account
                                                        <a href="{{ url('/citizen/login') }}" class="fw-medium text-primary"> <b>Login</b> </a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
