                                                ...
                                                <div>
                                                    ...
                                                    <form class="auth-input" method="POST" action="{{ url('/citizen/login/store') }}" enctype="multipart/form">
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <input id="mobile_no" type="mobile_no" onkeypress='validate(event)' maxlength="10" class="form-control @error('mobile_no') is-invalid @enderror" name="mobile_no" value="{{ old('mobile_no') }}" autocomplete="mobile_no" autofocus placeholder="Enter Mobile Number" required>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="current-password" placeholder="Enter Password" required>
    ...
    <script>
        $(document).ready(function() {
            $('#toggle-password').on('click', function() {
                ...
                var type = passwordField.attr('type') === 'password' ? 'text' : 'password'; // Toggle type
