                        ...
                        <div class="col-lg-12">
                            <div class="card" style="border: 1px solid #000000;">
                                <div class="card-body p-0">
                                    ...
                                    <form class="auth-input p-4" method="POST" action="{{ url('/provisional_building_noc/store') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group row mb-3 d-none">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <select class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden">
                                                    ...
                                                    <optgroup label=" ">
                                                        <option value="3" {{ old('noc_mode') == "5" ? 'selected' : '' }} selected>Provisional Building NOC</option>
                                                        <option value="4" {{ old('noc_mode') == "6" ? 'selected' : '' }}>Final Building NOC</option>
                                                    </optgroup>
                                                </select>
                                            </div>
                                        </div>
