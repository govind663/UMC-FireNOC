                                ...
                                <div class="card-body p-0">
                                    ...
                                    <form class="auth-input p-4" method="POST" action="{{ url('/provisional_building_noc/store') }}" enctype="multipart/form-data" autocomplete="off" >
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="tel_no" id="tel_no" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control" value="{{ old('tel_no') }}" placeholder="Enter Telephone No. (if any).">
                                                @error('tel_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
