                        ...
                        <div class="col-lg-12">
                            <div class="card" style="border: 1px solid #000000;">
                                <div class="card-body p-0">
                                    <h4 class="card-header text-light bg-primary ">Add Provisional Building NOC</h4>

                                    <form class="auth-input p-4" method="POST" action="{{ url('/provisional_building_noc/store') }}" enctype="multipart/form-data" autocomplete="off" >
                                        @csrf
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="electrol_panel_no" id="electrol_panel_no" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control @error('electrol_panel_no') is-invalid @enderror" value="{{ old('electrol_panel_no') }}" placeholder="Enter Electrol Panel No.">
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="contact_persion" id="contact_persion" class="form-control @error('contact_persion') is-invalid @enderror" value="{{ old('contact_persion') }}" placeholder="Enter Contact Person." oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="tel_no" id="tel_no" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control" value="{{ old('tel_no') }}" placeholder="Enter Telephone No. (if any).">
                                                @error('tel_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="peermission_no" id="peermission_no" maxlength="06" class="form-control @error('peermission_no') is-invalid @enderror" value="{{ old('peermission_no') }}" placeholder="Enter Construction Permission Number.">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="date" name="permission_date" id="permission_date" max="<?php echo date("Y-m-d"); ?>" class="form-control @error('permission_date') is-invalid @enderror" value="{{ old('permission_date') }}" placeholder="Enter Date of Permission.">
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="maps_of_proposed_doc" id="maps_of_proposed_doc" class="form-control  @error('maps_of_proposed_doc') is-invalid @enderror " value="{{ old('maps_of_proposed_doc') }}" placeholder="Upload Maps of Proposed Construction.">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="city_survey_doc" id="city_survey_doc" class="form-control @error('city_survey_doc') is-invalid @enderror" value="{{ old('city_survey_doc') }}" placeholder="Enter 7/12 Extract / City Survey Extract.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="competent_authority_doc" id="competent_authority_doc" class="form-control @error('competent_authority_doc') is-invalid @enderror" value="{{ old('competent_authority_doc') }}" placeholder="Enter Title & Search Report from competent Authority.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="dues_certificate_doc" id="dues_certificate_doc" class="form-control  @error('dues_certificate_doc') is-invalid @enderror " value="{{ old('dues_certificate_doc') }}" placeholder="Upload No dues certificate of Property & Water Tax.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
