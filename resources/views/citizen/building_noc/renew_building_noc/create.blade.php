                        ...
                        <div class="col-lg-12">
                            <div class="card" style="border: 1px solid #000000;">
                                <div class="card-body p-0">
                                    <h4 class="card-header text-light bg-primary ">Add Renew Building NOC</h4>

                                    <form class="auth-input p-4" method="POST" action="{{ url('/renew_building_noc/store') }}" enctype="multipart/form-data" autocomplete="off" >
                                        @csrf
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <select class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden">
                                                    ...
                                                    <optgroup label=" ">
                                                        ...
                                                        <option value="7" {{ old('noc_mode') == "7" ? 'selected' : '' }} selected>Renew Building NOC</option>
                                                    </optgroup>
                                                </select>
                                            </div>
                                        </div>
