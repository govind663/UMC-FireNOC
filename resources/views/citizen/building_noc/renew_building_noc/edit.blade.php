                        ...
                        <div class="col-lg-12">
                            <div class="card" style="border: 1px solid #000000;">
                                <div class="card-body p-0">
                                    <h4 class="card-header text-light bg-primary ">Edit Renew Building NOC</h4>

                                    <form class="auth-input p-4" method="POST" action='{{ url("/renew_building_noc/edit/update/{$data->RB_NOC_ID}/{$data->d_ID}/{$data->status}") }}' enctype="multipart/form-data" autocomplete="off" >
                                        @csrf
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <select class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden">
                                                    ...
                                                    <optgroup label=" ">
                                                        ...
                                                        <option value="7" {{ $data->noc_mode == "7" ? 'selected' : '' }}>Renew Building NOC</option>
                                                    </optgroup>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="society_name" id="society_name" class="form-control @error('society_name') is-invalid @enderror" value="{{ $data->society_name }}" placeholder="Enter Name of Building." oninput="this.value = this.value.replace(/[^A-Za-z]/g, '');">
                                                @error('society_name')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="electrol_panel_no" id="electrol_panel_no" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control @error('electrol_panel_no') is-invalid @enderror" value="{{ $data->electrol_panel_no }}" placeholder="Enter Electrol Panel No.">
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" name="tel_no" id="tel_no" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="10" value="{{ $data->tel_no }}" placeholder="Enter Telephone No. (if any).">
                                                @error('tel_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="date" name="permission_date" id="permission_date" max="<?php echo date("Y-m-d"); ?>" class="form-control @error('permission_date') is-invalid @enderror" value="{{ Carbon\Carbon::parse($data->permission_date)->format('Y-m-d') }}" placeholder="Enter Date of Permission.">
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="maps_of_proposed_doc" id="maps_of_proposed_doc" class="form-control  @error('maps_of_proposed_doc') is-invalid @enderror " value="{{ $data->maps_of_proposed_doc }}" placeholder="Upload Maps of Proposed Construction.">
                                                        ...
                                                        @if(!empty($data->maps_of_proposed_doc))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Building_NOC/Renewal_BuildingNOC/maps_of_proposed_doc/{{ $data->maps_of_proposed_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>

                                                    <label class="col-sm-2"><strong>Upload 7/12 Extract / City Survey Extract : </strong></label>
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="city_survey_doc" id="city_survey_doc" class="form-control @error('city_survey_doc') is-invalid @enderror" value="{{ $data->city_survey_doc }}" placeholder="Enter 7/12 Extract / City Survey Extract.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                        @error('city_survey_doc')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                        @enderror
                                                        ...
                                                        @if(!empty($data->city_survey_doc))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Building_NOC/Renewal_BuildingNOC/city_survey_doc/{{ $data->city_survey_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="sanad_doc" id="sanad_doc" class="form-control  @error('sanad_doc') is-invalid @enderror " value="{{ $data->sanad_doc }}" placeholder="Upload Sanad / Letter from S.D.O. Panvel.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                        ...
                                                        @if(!empty($data->sanad_doc))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Building_NOC/Renewal_BuildingNOC/sanad_doc/{{ $data->sanad_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>

                                                    <label class="col-sm-2"><strong>Upload Title & Search Report from competent Authority : </strong></label>
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="competent_authority_doc" id="competent_authority_doc" class="form-control @error('competent_authority_doc') is-invalid @enderror" value="{{ $data->competent_authority_doc }}" placeholder="Enter Title & Search Report from competent Authority.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                        @error('competent_authority_doc')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                        @enderror
                                                        ...
                                                        @if(!empty($data->competent_authority_doc))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Building_NOC/Renewal_BuildingNOC/competent_authority_doc/{{ $data->competent_authority_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    <label class="col-sm-2"><strong>Upload No dues certificate of Property & Water Tax : </strong></label>
                                                    <div class="col-sm-4 col-md-4">
                                                        <input type="file" accept=".jpg, .jpeg, .png, .pdf" name="dues_certificate_doc" id="dues_certificate_doc" class="form-control  @error('dues_certificate_doc') is-invalid @enderror " value="{{ $data->dues_certificate_doc }}" placeholder="Upload No dues certificate of Property & Water Tax.">
                                                        <small class="text-secondary"> Note : The file size should be less than 2MB .</small>
                                                        <br>
                                                        <small class="text-secondary"> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                        <br>
                                                        @error('dues_certificate_doc')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                        @enderror
                                                        ...
                                                        @if(!empty($data->dues_certificate_doc))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Building_NOC/Renewal_BuildingNOC/dues_certificate_doc/{{ $data->dues_certificate_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="col-md-12 col-xs-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-2 col-md-2">
                                                                <input type="text" name="d_pincode" id="d_pincode" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="06" class="form-control @error('d_pincode') is-invalid @enderror" value="{{ $data->d_pincode }}" placeholder="Enter Pincode.">
                                                                @error('d_pincode')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                        ...
                                        <div class="form-group row mt-4" >
                                            ...
                                            <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                <a href="{{ url('/renew_building_noc_list', $data->status) }}" class="btn btn-danger">Cancel</a>&nbsp;&nbsp;
