                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body" style="border: 1px solid rgb(3, 155, 155);">
                                        ...
                                        @if($status == 0)
                                        <h4 class="card-header text-primary">All Pending Final Building NOC List</h4>
                                        @elseif($status == 1)
                                        <h4 class="card-header text-primary">All Unpaid Final Building NOC List</h4>
                                        @elseif($status == 2)
                                        <h4 class="card-header text-primary">All Paid Final Building NOC List</h4>
                                        @elseif($status == 3)
                                        <h4 class="card-header text-primary">All Approved Final Building NOC List</h4>
                                        @elseif($status == 4)
                                        <h4 class="card-header text-primary">All Rejected Final Building NOC List</h4>
                                        @elseif($status == 5)
                                        <h4 class="card-header text-primary">All Underprocess Final Building NOC List</h4>
                                        @elseif($status == 6)
                                        <h4 class="card-header text-primary">All Reviewed Final Building NOC List</h4>
                                        @elseif($status == 7)
                                        <h4 class="card-header text-primary">All Invoice Generated Final Building NOC List</h4>
                                        @endif
                                                ...
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <a href='{{ url("/download_final_building_noc_pdf/{$value->F_NOC_ID}/{$value->status}") }}' class="btn btn-dark btn-sm ">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <form action='{{ url("/final_building_noc/delete/{$value->F_NOC_ID}/{$value->d_ID}/{$value->status}") }}' method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                            ...
                                                            &nbsp;&nbsp;
                                                            @if ($value->status == 3 )
                                                            <a href='{{ url("/certificate/{$value->F_NOC_ID}/{$value->status}/{$value->noc_mode}") }}' class="btn btn-warning btn-sm text-dark">
                                                    ...
                                                    {{-- Payment Receipt --}}
                                                    <div class="modal fade bs-example-modal-lg_{{ $value->F_NOC_ID }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <form class="auth-input p-4"  method="POST" action='{{ url("/upload_payment_receipt/{$value->F_NOC_ID}/{$value->status}/{$value->noc_mode}") }}' enctype="multipart/form-data" autocomplete="off" >
                                                                            @csrf
