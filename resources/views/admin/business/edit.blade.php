...
<html lang="en">
    ...
    <head>
        ...
        <title>UMC-Fire NOC | Edit Business </title>
                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        <h4 class="card-header text-light bg-primary ">Edit Business</h4>

                                        <form class="auth-input p-4"  method="POST" action="{{ route('business.update', $data->id) }}" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-3 col-md-3">
                                                    <input type="text" name="business_nature" id="business_nature" class="form-control @error('business_nature') is-invalid @enderror" value="{{ $data->business_nature }}" placeholder="Enter Nature / Particulars of Busines.">
