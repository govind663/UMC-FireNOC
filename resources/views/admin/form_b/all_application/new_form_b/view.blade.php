                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <form class="auth-input p-4" >
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <select class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden">
                                                        ...
                                                        <optgroup label=" ">
                                                            ...
                                                            <option value="11" {{ $data->noc_mode == "11" ? 'selected' : '' }}>Form B</option>
                                                        </optgroup>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <textarea type="text" disabled name="business_address" id="business_address" class="form-control @error('business_address') is-invalid @enderror" value="{{ $data->business_address }}" placeholder="Enter Address Of Other Place">{{ $data->business_address }}</textarea>
                                            ...
                                            <div class="form-group row mt-4" >
                                                ...
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/all_new_form_b_list', $all_status) }}" class="btn btn-danger">Cancel</a>&nbsp;&nbsp;
