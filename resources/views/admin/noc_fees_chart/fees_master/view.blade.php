...
<html lang="en">
    ...
    <head>
        ...
        <title>UMC-Fire NOC |  NOC Fees </title>
                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        <h4 class="card-header text-light bg-primary ">NOC Fees</h4>
                                        ...
                                        <form class="auth-input p-4" >
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-3 col-md-3">
                                                    <select disabled class="form-control select2 @error('fee_bldg_ht_id') is-invalid @enderror" name="fee_bldg_ht_id" id="fee_bldg_ht_id">
                                                ...
                                                <div class="col-sm-3 col-md-3">
                                                    <select disabled class="form-control select2 @error('fee_category_id') is-invalid @enderror" name="fee_category_id" id="fee_category_id">
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-3 col-md-3">
                                                    <input readonly type="text" name="rate" id="rate" class="form-control @error('rate') is-invalid @enderror" onkeypress='validate(event)' value="{{ $data->rate }}" placeholder="Enter Cost per Sq.Mt.">
                                                    @error('rate')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                ...
                                                <div class="col-sm-3 col-md-3">
                                                    <input readonly type="text" name="charges" id="charges" class="form-control @error('charges') is-invalid @enderror" onkeypress='validate(event)' value="{{ $data->charges }}" placeholder="Enter Minimum Charges.">
                                                    @error('charges')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
