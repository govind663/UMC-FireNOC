...
<head>
    ...
    <title>UMC-Fire NOC | Add NOC Fees </title>
                        ...
                        <div class="col-lg-12">
                            <div class="card" style="border: 1px solid #000000;">
                                <div class="card-body p-0">
                                    <h4 class="card-header text-light bg-primary ">Add NOC Fees</h4>

                                    <form class="auth-input p-4" method="POST" action="{{ route('fees_master.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-3 col-md-3">
                                                <input type="text" name="rate" id="rate" class="form-control @error('rate') is-invalid @enderror" onkeypress='validate(event)' value="{{ old('rate') }}" placeholder="Enter Cost per Sq.Mt.">
                                                @error('rate')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="col-sm-3 col-md-3">
                                                <input type="text" name="charges" id="charges" class="form-control @error('charges') is-invalid @enderror" onkeypress='validate(event)' value="{{ old('charges') }}" placeholder="Enter Minimum Charges.">
                                                @error('charges')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
