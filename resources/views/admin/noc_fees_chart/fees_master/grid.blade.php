...
<html lang="en">
    ...
    <head>
        ...
        <title>UMC-Fire NOC | NOC Fees List</title>
                                ...
                                <div class="card">
                                    <div class="card-body" style="border: 1px solid rgb(3, 155, 155);">
                                        <div class="col-md-12 col-sm-12 text-right">
                                            <a class="btn btn-primary" style="float:right;" href="{{ route('fees_master.create') }}" role="button">
                                                <b>+ &nbsp; Add NOC Fees</b>
                                            </a>
                                        </div>
                                        <h4 class="card-header text-primary">All NOC Fees List</h4>
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr style="color: white; background:#086070;">
                                                    ...
                                                    <th><b>Building Height / Type</b></th>
                                                    <th><b>Category of Construction</b></th>
                                                    <th><b>Cost per Sq.Mt.</b></th>
                                                    <th><b>Minimum Charges</b></th>
                                                    <th><b>View</b></th>
                                                    <th><b>Edit</b></th>
                                                    <th><b>Delete</b></th>
                                                </tr>
                                            ...
                                            <tbody>
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>{{ $value->fee_mode_operate?->operation_mode }}</td>
                                                        <td>{{ $value->fee_bldg_ht?->building_ht }}</td>
                                                        <td>{{ $value->fee_category?->category_name }}</td>
                                                        <td>{{ $value->rate }} <b> ₹</b></td>
                                                        <td>{{ $value->charges }} <b> ₹</b></td>
                                                        <td>
                                                            <a href="{{ route('fees_master.show', $value->id) }}" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View</i></b>
                                                            </a>
                                                        </td>

                                                        <td>
                                                            <a href="{{ route('fees_master.edit', $value->id) }}" class="btn btn-warning btn-sm text-dark">
                                                                <b><i class="mdi mdi-account-edit"> Edit</i></b>
                                                            </a>
                                                        </td>

                                                        <td>
                                                            <form action="{{ route('fees_master.destroy', $value->id) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
