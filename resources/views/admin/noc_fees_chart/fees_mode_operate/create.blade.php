                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        ...
                                        <form class="auth-input p-4"  method="POST" action="{{ route('fees_mode_operate.store') }}" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-3 col-md-3">
                                                    <input type="text" name="operation_mode" id="operation_mode" class="form-control @error('operation_mode') is-invalid @enderror" value="{{ old('operation_mode') }}" placeholder="Enter Type Of Construction.">
