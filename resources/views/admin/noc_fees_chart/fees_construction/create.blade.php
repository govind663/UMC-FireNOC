...
<html lang="en">
    ...
    <head>
        ...
        <title>UMC-Fire NOC | Add Types of Construction </title>
                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        <h4 class="card-header text-light bg-primary ">Add Types of Construction</h4>

                                        <form class="auth-input p-4"  method="POST" action="{{ route('fees_construction.store') }}" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-3 col-md-3">
                                                    <input type="text" name="construction_type" id="construction_type" class="form-control @error('construction_type') is-invalid @enderror" value="{{ old('construction_type') }}" placeholder="Enter Type Of Construction.">
