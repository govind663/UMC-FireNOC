...
<html lang="en">
    ...
    <head>
        ...
        <title>PMC-Fire NOC | Edit Types of Construction </title>
                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        ...
                                        <form class="auth-input p-4"  method="POST" action="{{ route('fees_construction.update', $data->id) }}" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group row  mb-3">
                                                <label class="col-sm-3"><strong>Nature / Particulars of Busines : <span style="color:red;">*</span></strong></label>
                                                <div class="col-sm-3 col-md-3">
                                                    <input type="text" name="construction_type" id="construction_type" class="form-control @error('construction_type') is-invalid @enderror" value="{{ $data->construction_type }}" placeholder="Enter Nature / Particulars of Busines.">
                                            ...
                                            <div class="form-group row mt-4" >
                                                ...
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ route('fees_construction.index') }}" class="btn btn-danger">Cancel</a>&nbsp;&nbsp;
