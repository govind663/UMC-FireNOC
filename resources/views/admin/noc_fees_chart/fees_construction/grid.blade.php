...
<html lang="en">
    ...
    <head>
        ...
        <title>UMC-Fire NOC | Types of Construction List</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body" style="border: 1px solid rgb(3, 155, 155);">
                                        ...
                                        <h4 class="card-header text-primary">All Types of Construction List</h4>
                                            ...
                                            <tbody>
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('fees_construction.show', $value->id) }}" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View</i></b>
                                                            </a>
                                                        </td>

                                                        <td>
                                                            <a href="{{ route('fees_construction.edit', $value->id) }}" class="btn btn-warning btn-sm text-dark">
                                                                <b><i class="mdi mdi-account-edit"> Edit</i></b>
                                                            </a>
                                                        </td>

                                                        <td>
                                                            <form action="{{ route('fees_construction.destroy', $value->id) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
