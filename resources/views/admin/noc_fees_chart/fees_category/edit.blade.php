...
<html lang="en">
    ...
    <head>
        ...
        <title>UMC-Fire NOC | Edit Categories of Construction </title>
                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        <h4 class="card-header text-light bg-primary ">Edit Categories of Construction</h4>

                                        <form class="auth-input p-4"  method="POST" action="{{ route('fees_category.update', $data->id) }}" enctype="multipart/form-data">
                                            @csrf
