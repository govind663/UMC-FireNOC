...
<html lang="en">
    ...
    <head>
        ...
        <title>UMC-Fire NOC | Categories Of Construction List</title>
                                ...
                                <div class="card">
                                    <div class="card-body" style="border: 1px solid rgb(3, 155, 155);">
                                        <div class="col-md-12 col-sm-12 text-left">
                                            <a class="btn btn-primary" style="float:right;" href="{{ route('fees_category.create') }}" role="button">
                                                <b>+ &nbsp; Add Categories Of Construction</b>
                                            </a>
                                        </div>
                                        <h4 class="card-header text-primary">All Categories Of Construction List</h4>
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr style="color: white; background:#086070;">
                                                    ...
                                                    <th><b>Construction Category</b></th>
                                                    <th><b>View</b></th>
                                                    <th><b>Edit</b></th>
                                                    <th><b>Delete</b></th>
                                                </tr>
                                            ...
                                            <tbody>
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('fees_category.show', $value->id) }}" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View</i></b>
                                                            </a>
                                                        </td>

                                                        <td>
                                                            <a href="{{ route('fees_category.edit', $value->id) }}" class="btn btn-warning btn-sm text-dark">
                                                                <b><i class="mdi mdi-account-edit"> Edit</i></b>
                                                            </a>
                                                        </td>

                                                        <td>
                                                            <form action="{{ route('fees_category.destroy', $value->id) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
