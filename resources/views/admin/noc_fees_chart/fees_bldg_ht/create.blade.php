...
<html lang="en">
    ...
    <head>
        ...
        <title>UMC-Fire NOC | Add Building Height / Type </title>
                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        <h4 class="card-header text-light bg-primary ">Add Building Height / Type</h4>

                                        <form class="auth-input p-4"  method="POST" action="{{ route('fees_bldg_ht.store') }}" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-3 col-md-3">
                                                    <input type="text" name="building_ht" id="building_ht" class="form-control @error('building_ht') is-invalid @enderror" value="{{ old('building_ht') }}" placeholder="Enter Type Of Construction.">
                                                    @error('building_ht')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
