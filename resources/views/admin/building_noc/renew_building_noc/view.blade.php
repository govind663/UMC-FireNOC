...
<body data-topbar="colored" data-layout="horizontal">
                        ...
                        <div class="col-lg-12">
                            <div class="card" style="border: 1px solid #000000;">
                                <div class="card-body p-0">
                                    <h4 class="card-header text-light bg-primary ">Renew Building NOC</h4>
                                    ...
                                    <form class="auth-input p-4" >
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input disabled type="text" name="contact_persion" id="contact_persion" class="form-control @error('contact_persion') is-invalid @enderror" value="{{ $data->contact_persion }}" placeholder="Enter Contact Person.">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input disabled type="text" name="tel_no" id="tel_no" class="form-control" value="{{ $data->tel_no }}" placeholder="Enter Telephone No. (if any).">
                                                @error('tel_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input disabled type="text" name="peermission_no" id="peermission_no" maxlength="06" class="form-control @error('peermission_no') is-invalid @enderror" value="{{ $data->peermission_no }}" placeholder="Enter Construction Permission Number.">
                                        ...
                                        <div class="row ">
                                            <div class="row ">
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <label class="col-sm-2"><strong>7/12 Extract / City Survey Extract : </strong></label>
                                                    <div class="col-sm-4 col-md-4">
                                                ...
                                                <div class="form-group row  mb-3">
                                                    <label class="col-sm-2"><strong>Sanad / Letter from S.D.O. Panvel : </strong></label>
                                                    <div class="col-sm-4 col-md-4">
                                                    ...
                                                    <label class="col-sm-2"><strong>Title & Search Report from competent Authority : </strong></label>
                                                    <div class="col-sm-4 col-md-4">
                                                ...
                                                <div class="form-group row  mb-3">
                                                    <label class="col-sm-2"><strong>No dues certificate of Property & Water Tax : </strong></label>
                                                    <div class="col-sm-4 col-md-4">
                                                ...
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="col-md-12 col-xs-12">
                                                        <p class="text-justify ">
                                                            <b> I / We..... <br><br>
                                                                <input disabled disabled type="text"  class="form-control @error('declare_by') is-invalid @enderror" id="declare_by" name="declare_by" value="{{ $data->declare_by }}" placeholder="Enter Applicant Name">
                                                                <br>
                                                                @error('declare_by')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                        ...
                                                        <b>Date : </b> <input disabled type="text" style="width:150px" class="form-control input-style" id="declare_date" placeholder="Permit Date" name="declare_date" value="{{ $data->declare_date }}" disabled>
                                                    </div>
                                        ...
                                        <div class="form-group row mt-4" >
                                            ...
                                            <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                <a href="{{ url('/admin_renew_building_noc_list', $data->status) }}" class="btn btn-primary">Cancel</a>
                                                &nbsp;&nbsp;
                                                @if ($data->status == 1)
                                                ...
                                                <a href='{{ url("/admin_renew_building_noc/approved/$data->RB_NOC_ID/$data->status/$auth_role") }}' class="btn btn-success text-light"><b>Accept</b></a>&nbsp;&nbsp;
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target=".PB_NOC_Reject"><b>Reject</b></button>
                                                @elseif(Auth::user()->role == 2 && $data->status == 2)
                                                <a href='{{ url("/admin_renew_building_noc/approved/$data->RB_NOC_ID/$data->status/$auth_role") }}' class="btn btn-success text-light"><b>Accept</b></a>&nbsp;&nbsp;
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target=".PB_NOC_Reject"><b>Reject</b></button>
                                                @elseif(Auth::user()->role == 1)
                                                {{-- <a href='{{ url("/admin_renew_building_noc/approved/$data->RB_NOC_ID/$data->status/$auth_role") }}' class="btn btn-success text-light"><b>Accept</b></a>&nbsp;&nbsp; --}}
                                                <button type="button" class="btn btn-warning text-dark" data-bs-toggle="modal" data-bs-target=".PB_NOC_Accept"><b>Accept</b></button>&nbsp;&nbsp;
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target=".PB_NOC_Reject"><b>Reject</b></button>
    ...
    {{-- Start Approved for Renew Building Application Model --}}
    <div class="modal fade PB_NOC_Accept" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary" id="myLargeModalLabel">Approve By Field Inspector For Renew Building NOC :</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <form class="auth-input p-3"  method="POST"  action='{{ url("/admin_renew_building_noc/field_inspector_approved/$data->RB_NOC_ID/$data->status/$auth_role") }}' enctype="multipart/form-data">
                            @csrf
    ...
    {{-- Start Reject for Provisional Building Application Model --}}
    <div class="modal fade PB_NOC_Reject" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary" id="myLargeModalLabel">Reject for Provisional Building NOC :</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <form class="auth-input p-4"  method="POST"  action='{{ url("/admin_renew_building_noc/rejected/$data->RB_NOC_ID/$data->status/$auth_role") }}' enctype="multipart/form-data">
                            @csrf
