                                                ...
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            ...
                                                            <a href='{{ url("/generate_provisional_building_noc_certificate/{$value->P_NOC_ID}/{$value->status}") }}' class="btn btn-dark btn-sm ">
                                                            ...
                                                            <a href='{{ url("/admin_certificate/{$value->P_NOC_ID}/{$value->status}/{$value->noc_mode}") }}' class="btn btn-warning btn-sm text-dark">
