                                                ...
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="col-md-12 col-xs-12">
                                                        <p class="text-justify ">
                                                            <b> I / We..... <br><br>
                                                                <input disabled disabled type="text" style="width:300px" class="form-control @error('declare_by') is-invalid @enderror" id="declare_by" name="declare_by" value="{{ $data->declare_by }}" placeholder="Enter Applicant Name">
                                                                <br>
                                                                @error('declare_by')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
