...
<body data-topbar="colored" data-layout="horizontal">
                                    ...
                                    <form class="auth-input p-4" >
                                        ...
                                        <div class="row ">
                                            <div class="row ">
                                                ...
                                                <div class="form-group row  mb-3">
                                                    <label class="col-sm-2"><strong>Sanad / Letter from S.D.O. Ulhasnagar : </strong></label>
                                                    <div class="col-sm-4 col-md-4">
                                        ...
                                        <div class="form-group row mt-4" >
                                            ...
                                            <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                ...
                                                &nbsp;&nbsp;
                                                @if ($data->status == 1)
                                                <a href='{{ url("/make_payment/create/{$data->P_NOC_ID}/{$data->status}/{$data->noc_mode}") }}' class="btn btn-success btn-sm ">
    ...
    {{-- Start Approved for Provisional Building Application Model --}}
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary" id="myLargeModalLabel">Approve By Field Inspector For Provisional Building NOC :</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <form class="auth-input p-3"  method="POST"  action='{{ url("/admin_provisional_building_noc/field_inspector_approved/$data->P_NOC_ID/$data->status/$auth_role") }}' enctype="multipart/form-data">
                            @csrf
    ...
    <div class="modal fade PB_NOC_Reject" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <form class="auth-input p-4"  method="POST"  action='{{ url("/admin_provisional_building_noc/rejected/$data->P_NOC_ID/$data->status/$auth_role") }}' enctype="multipart/form-data">
                            @csrf
