                                                ...
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <button type="button" class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target=".FB_NOC_Preview_{{ $value->F_NOC_ID }}"><b><i class="mdi mdi-eye-circle-outline"> View Field Inspector Remark</i></b></button>
                                                            @endif
                                                        </td>
                                                    </tr>

                                                    {{-- Start  View Field Inspector Remark  Model --}}
                                                    <div class="modal fade FB_NOC_Preview_{{ $value->F_NOC_ID }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title text-primary" id="myLargeModalLabel">Field Inspector Remark For Final Building NOC :</h5>
                                                                        ...
                                                                        <form class="auth-input p-3"  enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="form-group row mb-3">
                                                                                ...
                                                                                <div class="col-sm-4 col-md-4">
                                                                                    <a href="/UMC_FireNOC/Building_NOC/Final_BuildingNOC/construction_plan_doc/{{ $value->construction_plan_doc }}" target="_blank">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <p class="mt-3 mb-0" id="image_div">
                                                                                                <img src="/UMC_FireNOC/Building_NOC/Final_BuildingNOC/construction_plan_doc/{{ $value->construction_plan_doc }} " alt="image"  width="200" height="100" style="max-height:150px;">
                                                                                            </p>
                                                                                            <?php }
                                                                                            else{
                                                                                                ?>
                                                                                                <a href="/UMC_FireNOC/Building_NOC/Final_BuildingNOC/construction_plan_doc/{{ $value->construction_plan_doc }}" target="_blank" download>
                                                                                                    <p class="mt-3 mb-0" id="image_div">
