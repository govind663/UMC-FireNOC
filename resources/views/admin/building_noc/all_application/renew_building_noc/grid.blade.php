                                                ...
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            <a href='{{ url("/all_renew_building_noc/show/{$value->RB_NOC_ID}/{$all_status}") }}' class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View</i></b>
                                                            </a>
                                                            @if ($all_status == 0)
                                                            &nbsp;&nbsp;
                                                            <a href='{{ url("/admin_download_final_building_noc_pdf/{$value->RB_NOC_ID}/{$value->status}") }}' class="btn btn-dark btn-sm ">
