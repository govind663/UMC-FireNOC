                                                ...
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            ...
                                                            <a href='{{ url("/admin_invoice/{$value->NH_NOC_ID}/{$value->status}/{$value->noc_mode}") }}' class="btn btn-dark btn-sm ">
                                                                        ...
                                                                        <form class="auth-input p-3"  enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="form-group row mb-3">
                                                                                ...
                                                                                <div class="col-sm-4 col-md-4">
                                                                                    <a href="/PMC_FireNOC/Hospital_NOC/New_HospitalNOC/f_inspector_doc/{{ $value->f_inspector_doc }}" target="_blank">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <p class="mt-3 mb-0" id="image_div">
                                                                                                <img src="/PMC_FireNOC/Hospital_NOC/New_HospitalNOC/f_inspector_doc/{{ $value->f_inspector_doc }} " alt="image"  width="200" height="100" style="max-height:150px;">
                                                                                            </p>
                                                                                            <?php }
                                                                                            else{
                                                                                                ?>
                                                                                                <a href="/PMC_FireNOC/Hospital_NOC/New_HospitalNOC/f_inspector_doc/{{ $value->f_inspector_doc }}" target="_blank" download>
                                                                                                    <p class="mt-3 mb-0" id="image_div">
