...
<body data-topbar="colored" data-layout="horizontal">
                        ...
                        <div class="col-lg-12">
                            <div class="card" style="border: 1px solid #000000;">
                                <div class="card-body p-0">
                                    <h4 class="card-header text-light bg-primary ">New Hospital NOC</h4>
                                    ...
                                    <form class="auth-input p-4" >
                                        ...
                                        <div class="form-group row mb-3 d-none">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <select disabled class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden">
                                                    ...
                                                    <optgroup label=" ">
                                                        <option value="3" {{ $data->noc_mode == "3" ? 'selected' : '' }} selected>New Hospital NOC</option>
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <input type="text" disabled name="hospital_name" id="hospital_name" class="form-control @error('hospital_name') is-invalid @enderror" value="{{ $data->hospital_name }}" placeholder="Enter Name of Hospital.">
                                                @error('hospital_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group row  mb-3">
                                            ...
                                            <div class="col-sm-2 col-md-2">
                                                <select disabled class="form-control select2 @error('hospital_fireequip') is-invalid @enderror" name="hospital_fireequip" id="hospital_fireequip">
                                        ...
                                        <div class="form-group row mt-4" >
                                            ...
                                            <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                ...
                                                {{-- <a href='{{ url("/admin_new_hospital_noc/approved/$data->NH_NOC_ID/$data->status/$auth_role") }}' class="btn btn-success text-light"><b>Accept</b></a>&nbsp;&nbsp; --}}
                                                <button type="button" class="btn btn-warning text-dark" data-bs-toggle="modal" data-bs-target=".NH_NOC_Accept"><b>Accept</b></button>&nbsp;&nbsp;
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target=".NH_NOC_Reject"><b>Reject</b></button>
    ...
    {{-- Start Approved for New Hospital Application Model --}}
    <div class="modal fade NH_NOC_Accept" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary" id="myLargeModalLabel">Approve By Field Inspector For New Hospital NOC :</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <form class="auth-input p-3"  method="POST"  action='{{ url("/admin_new_hospital_noc/field_inspector_approved/$data->NH_NOC_ID/$data->status/$auth_role") }}' enctype="multipart/form-data">
                            @csrf
    ...
    <div class="modal fade NH_NOC_Reject" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <form class="auth-input p-4"  method="POST"  action='{{ url("/admin_new_hospital_noc/rejected/$data->NH_NOC_ID/$data->status/$auth_role") }}' enctype="multipart/form-data">
                            @csrf
