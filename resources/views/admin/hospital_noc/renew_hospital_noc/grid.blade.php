                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            ...
                                                            @elseif (Auth::user()->role == 3 && $value->status == 2 && $value->citizen_payment_status == 2)
                                                                ...
                                                                <button type="button" class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target=".RH_NOC_Preview_{{ $value->NB_NOC_ID }}"><b><i class="mdi mdi-eye-circle-outline">View Field Inspector Remark</i></b></button>
                                                            @endif
