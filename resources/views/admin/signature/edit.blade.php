                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        <h4 class="card-header text-light bg-primary ">Edit Signature</h4>

                                        <form class="auth-input p-4"  method="POST" action="{{ route('signature.update', $data->id) }}" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-3 col-md-3">
                                                    <input type="file" id="file-input" accept=".pdf, .png, .jpg, .jpeg" onchange="previewFile()" name="upload_signature_doc" class="form-control @error('upload_signature_doc') is-invalid @enderror" value="{{ $data->upload_signature_doc }}" placeholder="Upload Signature">
