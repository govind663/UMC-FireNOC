...
<html lang="en">
    ...
    <body data-topbar="colored" data-layout="horizontal">
                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        <h4 class="card-header text-light bg-primary ">Renew Business NOC</h4>
                                        ...
                                        <form class="auth-input p-4" >
                                            ...
                                            <div class="form-group row mt-4" >
                                                ...
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/admin_renew_business_noc_list', $data->status) }}" class="btn btn-primary">Cancel</a>
                                                    &nbsp;&nbsp;
                                                    @if ($data->status == 1)
                                                    ...
                                                    <a href='{{ url("/admin_renew_business_noc/approved/$data->RB_NOC_ID/$data->status/$auth_role") }}' class="btn btn-success text-light"><b>Accept</b></a>&nbsp;&nbsp;
        ...
        {{-- Start Approved for Renew Business Application Model --}}
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-primary" id="myLargeModalLabel">Approve By Field Inspector For Renew Business NOC :</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <form class="auth-input p-3"  method="POST"  action='{{ url("/admin_renew_business_noc/field_inspector_approved/$data->RB_NOC_ID/$data->status/$auth_role") }}' enctype="multipart/form-data">
                                @csrf
        ...
        <div class="modal fade RB_NOC_Reject" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form class="auth-input p-4"  method="POST"  action='{{ url("/admin_renew_business_noc/rejected/$data->RB_NOC_ID/$data->status/$auth_role") }}' enctype="multipart/form-data">
                                @csrf
