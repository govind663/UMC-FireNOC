                                                ...
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            ...
                                                            @if ($value->status == 0)
                                                            <a href='{{ url("/admin_download_renew_business_noc_pdf/{$value->RB_NOC_ID}/{$value->status}") }}' class="btn btn-dark btn-sm ">
                                                            ...
                                                            <a href='{{ url("/generate_renew_business_noc_certificate/{$value->RB_NOC_ID}/{$value->status}") }}' class="btn btn-dark btn-sm ">
                                                            ...
                                                            <a href='{{ url("/admin_certificate/{$value->RB_NOC_ID}/{$value->status}/{$value->noc_mode}") }}' class="btn btn-warning btn-sm text-dark">
                                                    ...
                                                    <div class="modal fade RB_NOC_Preview_{{ $value->RB_NOC_ID }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title text-primary" id="myLargeModalLabel">Field Inspector Remark For Renew Business NOC :</h5>
                                                                        ...
                                                                        <form class="auth-input p-3"  enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="form-group row mb-3">
                                                                                ...
                                                                                <div class="col-sm-4 col-md-4">
                                                                                    <a href="{{url('/')}}/UMC_FireNOC/Business_NOC/Renew_BusinessNOC/f_inspector_doc/{{ $value->f_inspector_doc }}" target="_blank">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <p class="mt-3 mb-0" id="image_div">
                                                                                                <img src="{{url('/')}}/UMC_FireNOC/Business_NOC/Renew_BusinessNOC/f_inspector_doc/{{ $value->f_inspector_doc }} " alt="image"  width="200" height="100" style="max-height:150px;">
                                                                                            </p>
                                                                                            <?php }
                                                                                            else{
                                                                                                ?>
                                                                                                <a href="{{url('/')}}/UMC_FireNOC/Business_NOC/Renew_BusinessNOC/f_inspector_doc/{{ $value->f_inspector_doc }}" target="_blank" download>
                                                                                                    <p class="mt-3 mb-0" id="image_div">
