                                                                        ...
                                                                        <form class="auth-input p-3"  enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="form-group row mb-3">
                                                                                ...
                                                                                <div class="col-sm-4 col-md-4">
                                                                                    <a href="{{url('/')}}/UMC_FireNOC/Business_NOC/New_BusinessNOC/construction_plan_doc/{{ $value->construction_plan_doc }}" target="_blank">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <p class="mt-3 mb-0" id="image_div">
                                                                                                <img src="{{url('/')}}/UMC_FireNOC/Business_NOC/New_BusinessNOC/construction_plan_doc/{{ $value->construction_plan_doc }} " alt="image"  width="200" height="100" style="max-height:150px;">
                                                                                            </p>
                                                                                            <?php }
                                                                                            else{
                                                                                                ?>
                                                                                                <a href="{{url('/')}}/UMC_FireNOC/Business_NOC/New_BusinessNOC/construction_plan_doc/{{ $value->construction_plan_doc }}" target="_blank" download>
                                                                                                    <p class="mt-3 mb-0" id="image_div">
