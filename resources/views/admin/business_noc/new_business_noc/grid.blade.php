                                                ...
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            ...
                                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target=".NB_NOC_Preview"><b>View Field Inspector Remark</b></button>
                                                            @endif
                                                        </td>
                                                    ...
                                                    <div class="modal fade NB_NOC_Preview" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
