...
<html lang="en">
    ...
    <head>
        ...
        <title>PMC-Fire NOC | Renew Other NOC</title>
    ...
    <body data-topbar="colored" data-layout="horizontal">
                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: 1px solid #000000;">
                                    <div class="card-body p-0">
                                        <h4 class="card-header text-light bg-primary ">Renew Other NOC</h4>
                                        ...
                                        <form class="auth-input p-4" >
                                            ...
                                            <div class="form-group row mb-3 d-none">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <select disabled class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden">
                                                        ...
                                                        <optgroup label=" ">
                                                            {{-- <option value="8" {{ $data->noc_mode == "8" ? 'selected' : '' }} >New Other NOC</option> --}}
                                                            <option value="9" {{ $data->noc_mode == "9" ? 'selected' : '' }} selected>Renewal Other NOC</option>
                                                        </optgroup>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <input type="text" disabled name="society_name" id="society_name" class="form-control @error('society_name') is-invalid @enderror" value="{{ $data->society_name }}" placeholder="Enter Name of Other.">
                                                    @error('society_name')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row  mb-3">
                                                <label disabled class="col-sm-2"><strong>Existing NOC Renewal Date as per the documents : </strong></label>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        @if(!empty($data->location_map_doc))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/location_map_doc/{{ $data->location_map_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        @if(!empty($data->electric_license_doc))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/electric_license_doc/{{ $data->electric_license_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        @if(!empty($data->gas_license_doc))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/gas_license_doc/{{ $data->gas_license_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        @if(!empty($data->shop_license_doc))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/shop_license_doc/{{ $data->shop_license_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        @if(!empty($data->food_license))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/food_license/{{ $data->food_license }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        @if(!empty($data->tax_bill_paid_doc))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/tax_bill_paid_doc/{{ $data->tax_bill_paid_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        @if(!empty($data->trade_license))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/trade_license/{{ $data->trade_license }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        @if(!empty($data->gas_certificate_doc))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/gas_certificate_doc/{{ $data->gas_certificate_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="form-group row  mb-3">
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        @if(!empty($data->commissioning_certificate))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/commissioning_certificate/{{ $data->commissioning_certificate }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4 col-md-4">
                                                        @if(!empty($data->construction_plan_doc))
                                                            <a href="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/construction_plan_doc/{{ $data->construction_plan_doc }}" target="_blank" class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View Document </i></b>
                                                            </a>
                                                        @endif
                                                    </div>
                                            ...
                                            <div class="form-group row mt-4" >
                                                ...
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/admin_renew_other_noc_list', $data->status) }}" class="btn btn-primary">Cancel</a>
                                                    &nbsp;&nbsp;
                                                    @if ($data->status == 1)
                                                    <a href='{{ url("/make_payment/create/{$data->ON_NOC_ID}/{$data->status}/{$data->noc_mode}") }}' class="btn btn-success btn-sm ">
                                                    ...
                                                    <a href='{{ url("/admin_renew_other_noc/approved/$data->ON_NOC_ID/$data->status/$auth_role") }}' class="btn btn-success text-light"><b>Accept</b></a>&nbsp;&nbsp;
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target=".RB_NOC_Reject"><b>Reject</b></button>
                                                    @elseif(Auth::user()->role == 2 && $data->status == 2)
                                                    <a href='{{ url("/admin_renew_other_noc/approved/$data->ON_NOC_ID/$data->status/$auth_role") }}' class="btn btn-success text-light"><b>Accept</b></a>&nbsp;&nbsp;
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target=".RB_NOC_Reject"><b>Reject</b></button>
                                                    @elseif(Auth::user()->role == 1)
                                                    {{-- <a href='{{ url("/admin_renew_other_noc/approved/$data->ON_NOC_ID/$data->status/$auth_role") }}' class="btn btn-success text-light"><b>Accept</b></a>&nbsp;&nbsp; --}}
                                                    <button type="button" class="btn btn-warning text-dark" data-bs-toggle="modal" data-bs-target=".RB_NOC_Accept"><b>Accept</b></button>&nbsp;&nbsp;
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target=".RB_NOC_Reject"><b>Reject</b></button>
        ...
        {{-- Start Approved for Renew Other Application Model --}}
        <div class="modal fade RB_NOC_Accept" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-primary" id="myLargeModalLabel">Approve By Field Inspector For Renew Other NOC :</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <form class="auth-input p-3"  method="POST"  action='{{ url("/admin_renew_other_noc/field_inspector_approved/$data->ON_NOC_ID/$data->status/$auth_role") }}' enctype="multipart/form-data">
                                @csrf
        ...
        <div class="modal fade RB_NOC_Reject" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-primary" id="myLargeModalLabel">Reject for Renew Bussiness NOC :</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <form class="auth-input p-4"  method="POST"  action='{{ url("/admin_renew_other_noc/rejected/$data->ON_NOC_ID/$data->status/$auth_role") }}' enctype="multipart/form-data">
                                @csrf
