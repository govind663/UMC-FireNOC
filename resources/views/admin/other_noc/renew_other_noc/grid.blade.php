                                                ...
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            <a href='{{ url("/admin_renew_other_noc/show/{$value->ON_NOC_ID}/{$value->status}") }}' class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View</i></b>
                                                            </a>
                                                            @if ($value->status == 0)
                                                            &nbsp;&nbsp;
                                                            <a href='{{ url("/admin_download_renew_other_noc_pdf/{$value->ON_NOC_ID}/{$value->status}") }}' class="btn btn-dark btn-sm ">
                                                            ...
                                                            <a href='{{ url("/admin_invoice/{$value->ON_NOC_ID}/{$value->status}/{$value->noc_mode}") }}' class="btn btn-dark btn-sm ">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <button type="button" class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target=".RB_NOC_Preview_{{ $value->ON_NOC_ID }}"><b><i class="mdi mdi-eye-circle-outline">View Field Inspector Remark</i></b></button>
                                                            @endif
                                                    ...
                                                    <div class="modal fade RB_NOC_Preview_{{ $value->ON_NOC_ID }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title text-primary" id="myLargeModalLabel">Field Inspector Remark For Renew Other NOC :</h5>
                                                                        ...
                                                                        <form class="auth-input p-3"  enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="form-group row mb-3">
                                                                                ...
                                                                                <div class="col-sm-4 col-md-4">
                                                                                    <a href="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/f_inspector_doc/{{ $value->f_inspector_doc }}" target="_blank">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <p class="mt-3 mb-0" id="image_div">
                                                                                                <img src="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/f_inspector_doc/{{ $value->f_inspector_doc }} " alt="image"  width="200" height="100" style="max-height:150px;">
                                                                                            </p>
                                                                                            <?php }
                                                                                            else{
                                                                                                ?>
                                                                                                <a href="{{url('/')}}/PMC_FireNOC/Other_NOC/Renew_OtherNOC/f_inspector_doc/{{ $value->f_inspector_doc }}" target="_blank" download>
                                                                                                    <p class="mt-3 mb-0" id="image_div">
