                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <form class="auth-input p-4" >
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <select class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden">
                                                        ...
                                                        <optgroup label=" ">
                                                            ...
                                                            <option value="9" {{ $data->noc_mode == "9" ? 'selected' : '' }}>Renewal Other NOC</option>
                                                        </optgroup>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <select class="form-control select2 @error('types_of_other') is-invalid @enderror" disabled name="types_of_other" id="types_of_other">
                                                        <option value="">Select Type of Other</option>
                                                        <optgroup label=" ">
                                                            <option value="1" {{ $data->types_of_other == "1"? 'selected' : '' }}>Temporary</option>
                                                            <option value="2" {{ $data->types_of_other == "2"? 'selected' : '' }}>Fixed</option>
                                                        </optgroup>
                                                    </select>
                                                    @error('types_of_other')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    @enderror
                                            ...
                                            <div class="form-group row  mb-3">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <select class="form-control select2 @error('fire_equips') is-invalid @enderror" disabled name="fire_equips" id="fire_equips" >
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <textarea type="text" disabled name="other_address" id="other_address" class="form-control @error('other_address') is-invalid @enderror" value="{{ $data->other_address }}" placeholder="Enter Address Of Other Place">{{ $data->other_address }}</textarea>
                                                    @error('other_address')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row mt-4" >
                                                ...
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/all_new_other_noc_list', $all_status) }}" class="btn btn-danger">Cancel</a>&nbsp;&nbsp;
