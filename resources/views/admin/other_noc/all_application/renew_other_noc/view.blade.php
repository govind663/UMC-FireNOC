                                        ...
                                        <form class="auth-input p-4" >
                                            ...
                                            <div class="form-group row mb-3 d-none">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <select class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden">
                                                        ...
                                                        <optgroup label=" ">
                                                            <option value="8" {{ $data->noc_mode == "8" ? 'selected' : '' }} selected>New Bussiness NOC</option>
                                                            <option value="9" {{ $data->noc_mode == "9" ? 'selected' : '' }}>Renewal Bussiness NOC</option>
                                                        </optgroup>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mt-4" >
                                                ...
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/all_renew_other_noc_list', $all_status) }}" class="btn btn-danger">Cancel</a>&nbsp;&nbsp;
