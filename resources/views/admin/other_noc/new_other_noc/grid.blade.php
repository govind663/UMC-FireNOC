                                                ...
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display:flex;">
                                                            <a href='{{ url("/admin_new_other_noc/show/{$value->NC_NOC_ID}/{$value->status}") }}' class="btn btn-primary btn-sm">
                                                                <b><i class="mdi mdi-eye-circle-outline"> View</i></b>
                                                            </a>
                                                            @if ($value->status == 0)
                                                            &nbsp;&nbsp;
                                                            <a href='{{ url("/admin_download_new_other_noc_pdf/{$value->NC_NOC_ID}/{$value->status}") }}' class="btn btn-dark btn-sm ">
                                                            ...
                                                            <a href='{{ url("/admin_invoice/{$value->NC_NOC_ID}/{$value->status}/{$value->noc_mode}") }}' class="btn btn-dark btn-sm ">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <button type="button" class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target=".NB_NOC_Preview_{{ $value->NC_NOC_ID }}"><b><i class="mdi mdi-eye-circle-outline">View Field Inspector Remark</i></b></button>
                                                            @endif
                                                        </td>
                                                    ...
                                                    <div class="modal fade NB_NOC_Preview_{{ $value->NC_NOC_ID }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
