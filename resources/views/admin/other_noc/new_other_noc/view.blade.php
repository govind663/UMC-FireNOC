...
<html lang="en">
    ...
    <head>
        ...
        <title>PMC-Fire NOC | New Other NOC</title>
                                        ...
                                        <form class="auth-input p-4" >
                                            ...
                                            <div class="form-group row mb-3 d-none">
                                                ...
                                                <div class="col-sm-2 col-md-2">
                                                    <select class="form-control select2 " name="noc_mode" id="noc_mode" type="hidden" disabled>
                                                        ...
                                                        <optgroup label=" ">
                                                            <option value="8" {{ $data->noc_mode == "8" ? 'selected' : '' }} selected>New Other NOC</option>
                                            ...
                                            <div class="form-group row mt-4" >
                                                ...
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    ...
                                                    &nbsp;&nbsp;
                                                    @if ($data->status == 1)
                                                    <a href='{{ url("/make_payment/create/{$data->NC_NOC_ID}/{$data->status}/{$data->noc_mode}") }}' class="btn btn-success btn-sm ">
                                                    ...
                                                    <a href='{{ url("/admin_new_other_noc/approved/$data->NC_NOC_ID/$data->status/$auth_role") }}' class="btn btn-success text-light"><b>Accept</b></a>&nbsp;&nbsp;
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-primary" id="myLargeModalLabel">Approve By Field Inspector For New Other NOC :</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <form class="auth-input p-3"  method="POST"  action='{{ url("/admin_new_other_noc/field_inspector_approved/$data->NC_NOC_ID/$data->status/$auth_role") }}' enctype="multipart/form-data">
                                @csrf
        ...
        <div class="modal fade NB_NOC_Reject" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form class="auth-input p-4"  method="POST"  action='{{ url("/admin_new_other_noc/rejected/$data->NC_NOC_ID/$data->status/$auth_role") }}' enctype="multipart/form-data">
                                @csrf
