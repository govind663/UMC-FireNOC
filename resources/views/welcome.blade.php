                                        ...
                                        <div class="card my-auto overflow-hidden">
                                            <div class="p-lg-5 p-4">
                                                <div class="text-center mb-4">
                                                    <a href="{{ asset('/') }}" class="">
                                                        <img src="{{ asset('assets/logo/pmc-logo.png') }}" alt="PMC-firenoc" height="200" width="260" class="auth-logo logo-dark mx-auto">
                                                        <img src="{{ asset('assets/logo/pmc-logo.png') }}" alt="PMC-firenoc" height="200" width="260" class="auth-logo logo-light mx-auto">
                                                    </a>
