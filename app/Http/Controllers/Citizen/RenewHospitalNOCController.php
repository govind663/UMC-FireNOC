...
class RenewHospitalNOCController extends Controller
{
    ...
    public function update(Request $request, $id, $n_id, $status)
    {
        ...
        return redirect( )->route('renew_hospital_noc_list',$status)->with('message', 'The application form which you had updated for your new hospital noc has been done Successfully.');
    }
