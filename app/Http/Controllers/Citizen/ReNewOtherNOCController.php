...
use App\Http\Requests\RenewalOtherNOCRequest;
use App\Models\CitizenPayment;
use App\Models\FeeReceiptDocument;
use Barryvdh\DomPDF\Facade\Pdf as FacadePdf;
class ReNewOtherNOCController extends Controller
{
    /**
    ...
    public function index($status)
    {
        ...
        return view('citizen.other_noc.renew_other_noc.grid')->with('data', $data)->with('status', $status);
    }
    ...
    public function create()
    {
        ...
        return view('citizen.other_noc.renew_other_noc.create')->with('busines_mst', $busines_mst);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(RenewalOtherNOCRequest $request)
    {
        ...
        return redirect('/citizen/dashboard')->with('message', 'The application form which you had filled for your renew business noc has been done Successfully.');
    }
    ...
    public function show($id, $status)
    {
        ...
        return view('citizen.other_noc.renew_other_noc.view')->with('data', $data)->with('status', $status);
    }
    ...
    public function edit($id, $status)
    {
        ...
        return view('citizen.other_noc.renew_other_noc.edit')->with('data', $data)->with('status', $status);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(RenewalOtherNOCRequest $request, $id, $n_id, $status)
    {
        if($status == 0){
            ...
            return redirect()->route('renew_other_noc_list',$status)->with('message', 'The application form which you had updated for your renew Other noc has been done Successfully.');
            ...
            return redirect()->route('renew_other_noc_list',$currentRejStatus)->with('message', 'The application form which you had updated for your renew other noc has been done Successfully.');
        }
    }
    ...
    public function destroy($id, $n_id, $status)
    {
        ...
        return redirect()->route('renew_other_noc_list',$status)->with('message', 'The application form which you had deleted for your renew business noc has been done Successfully.');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function download_renew_other_noc_pdf($id, $status)
    {
        if($status == 0 || $status == 5 || $status == 1){
        ...
        return FacadePdf::loadView('citizen.other_noc.renew_other_noc.renew_other_noc_pdf', compact('data','status'))->stream("Renew Business NOC #".$data->RB_NOC_ID.".pdf");
    }
}
